document.addEventListener('DOMContentLoaded', () => {
    ...
    let shuffledChallenges = shuffleArray([...challenges]).slice(0, 3);
    const challengeTriggers = [2, 4, 6]; // Show modal before 3rd, 5th, and 7th messages
    ...
    startNewChatBtn.addEventListener('click', () => {
        ...
        shuffledChallenges = shuffleArray([...challenges]).slice(0, 3);  // Reshuffle challenges
    });
